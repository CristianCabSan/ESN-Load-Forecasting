...
# ABC parameters
Population = 50
employedBees = div(Population+1, 2)
onlookerBees = div(Population+1, 2)
limit = 10
...
function main()
	...
	optimize(fitness, [low_alpha low_beta low_rho low_in_s; upper_alpha upper_beta upper_rho upper_in_s], custom_abc; logger=custom_logger)
	#close(lg)
end
